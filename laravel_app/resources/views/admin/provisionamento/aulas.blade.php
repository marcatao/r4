    ...
    <div class="col-md-9">
        <div class="ibox ">
            <div class="ibox-title">
                <h5>Classes cadastradas no sistema</h5>
             </div>
            ...
            <div class="ibox-content"> 
                ...
                @endphp
                <label for="periodo">Mês selecionado para listar as classes:</label>
...
<script>
    ...
    function carrega_provisionamentos(){
        ...
        requisicao('{{ route('provisionamento_lista') }}','get',$('#periodo').val())
         .then(result => {
